...
RSpec.feature "Listing Articles" do
  ...
  scenario "A user lists all articles with and user not signed in" do
    visit "/"
  ...
  scenario "A user lists all articles with and user signed in" do
    login_as(@john)
  ...
  scenario "A user has not articles" do
    Article.delete_all
